        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-center min-h-screen max-w-7xl mx-auto">
          ...
          <div className="hidden lg:flex justify-center lg:justify-start order-2 lg:order-1">
            <div className="relative">
              <div className="hero-image relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 xl:w-80 xl:h-80 rounded-full overflow-hidden border-4 border-gradient-to-r from-cyan-400 to-purple-400 p-1">
              ...
              <div className="floating-element absolute -top-4 -right-4 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full opacity-70" />
              <div className="floating-element absolute -bottom-4 -left-4 w-4 h-4 sm:w-6 sm:h-6 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full opacity-70" />
              <div className="floating-element absolute top-1/2 -right-6 sm:-right-8 w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-teal-400 to-green-500 rounded-full opacity-70" />
            </div>
          </div>
          ...
          <div className="lg:col-span-2 text-center lg:text-left space-y-6 sm:space-y-8 w-full order-1 lg:order-2">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h1 
                ref={nameRef}
                className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white tracking-tight leading-tight whitespace-nowrap overflow-hidden"
                style={{ 
              ...
              <h2 
                ref={titleRef}
                className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-light text-gray-300 tracking-wide"
            ...
            {/* Description */}
            <p className="hero-description text-white/80 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl glass-effect rounded-lg p-3 sm:p-4 mx-auto lg:mx-0">
            ...
            {/* Tech Stack */}
            <div className="space-y-3 sm:space-y-4">
              <h3 className="text-white font-semibold text-base sm:text-lg">Tech Stack</h3>
