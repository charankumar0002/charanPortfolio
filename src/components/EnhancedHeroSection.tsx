    ...
    if (container && name && title) {
      ...
      const titleLetters = titleText
        ...
        .map((letter) =>
          letter === " "
            ? "&nbsp;"
            : `<span class="letter" data-letter="${letter}" style="display: inline-block;">${letter}</span>`
        )
        .join("");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-center min-h-screen max-w-7xl mx-auto pt-20 sm:pt-24 md:pt-16 lg:pt-0">
          ...
          <div className="lg:col-span-2 text-center lg:text-left space-y-4 sm:space-y-6 md:space-y-8 w-full order-1 lg:order-2">
            ...
            <p className="hero-description text-white/80 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl glass-effect rounded-lg p-3 sm:p-4 mx-auto lg:mx-0">
              Passionate full-stack developer with 2.7+ years of experience
              crafting responsive, user-centric web applications using modern
              technologies.
            </p>
